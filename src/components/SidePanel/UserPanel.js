...
class UserPanel extends React.Component {
  ...
  dropdownOptions = () => [
    {
      key: 'user',
      text: <span>Logged in as <strong>{this.state.user.displayName}</strong></span>,
      disabled: true
    },
    {
      key: 'avatar',
  ...
  uploadCroppedImage = () => {
    ...
    storageRef
      ...
      .put(blob, metadata)
      .then(snap => {
        snap.ref.getDownloadURL().then(downlodURL => {
          this.setState({ uploadCroppedImage: downlodURL }, () => { this.changeAvatar() });
        })
      })
  }
        ...
        <Grid.Column>
          <Grid.Row style={{ padding: '1.2em', margin: '0' }}>
            <Header inverted floated="left" as="h2">
              <Icon name="paper plane outline" style={{ padding: '1rem' }} />
              <Header.Content>Valor</Header.Content>
            </Header>
